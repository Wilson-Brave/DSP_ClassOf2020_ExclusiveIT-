...
public type CaliBasedSongsStorageSystemBlockingClient client object {
    ...
    *grpc:AbstractClientEndpoint;
    ...
    public remote function Update(updateRecord req, grpc:Headers? headers = ()) returns ([Confirmation, grpc:Headers]|grpc:Error) {
...
public type CaliBasedSongsStorageSystemClient client object {
    ...
    *grpc:AbstractClientEndpoint;
    ...
    public remote function Update(updateRecord req, service msgListener, grpc:Headers? headers = ()) returns (grpc:Error?) {
